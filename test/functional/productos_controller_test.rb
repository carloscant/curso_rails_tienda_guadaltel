...
class ProductosControllerTest < ActionController::TestCase
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post :create, producto: { descripcion: @producto.descripcion, imagen_url: @producto.imagen_url, nombre: @producto.nombre, precio: @producto.precio }
    end
  ...
  test "should update producto" do
    put :update, id: @producto, producto: { descripcion: @producto.descripcion, imagen_url: @producto.imagen_url, nombre: @producto.nombre, precio: @producto.precio }
    assert_redirected_to producto_path(assigns(:producto))
  end
